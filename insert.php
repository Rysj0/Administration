...
?>
<body  style="background-image: url(assets/img/5.jpg);background-size: 200% ;background-repeat: no-repeat;">
	<div class="container" >
			...
			<div
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" method="post" action="insertdo.php">
							<br />
							...
							<input type="submit" name="hh" value="确认添加"
								class="btn btn-primary ">
                                 <a href="control.php"><input type='button' class="btn btn-primary " value='取消添加' />
							<hr />
