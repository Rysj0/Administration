        ...
        <div class="row text-center ">
         ...
         <div class="row ">
                  ...
                  <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        ...
                        <strong>   输入注册信息 </strong>  
                            </div>
                            <div class="panel-body">
                                <form role="form" method= "post"  action= "registerdo.php">
                                       <br />
                                     <div class="form-group input-group">
                                            ...
                                            <input type="password" class="form-control"  placeholder="在此输入密码" name='password' />
                                        </div>
                                        <div class="form-group input-group">
								<span class="input-group-addon"><i class="fa fa-lock"></i></span>
                           ...
                           <img src="code.php" onclick="show()" id = "img" /><br/>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <a href="login.php"><input type='' class="btn btn-primary " value='有账号？去登录' /></a>
                                    <hr />
